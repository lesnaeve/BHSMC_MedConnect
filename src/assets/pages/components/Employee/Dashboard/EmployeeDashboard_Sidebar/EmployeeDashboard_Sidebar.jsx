...
const EmployeeDashboard_Sidebar = () => {
  return (
    <div className='employee-menu'>
            ...
            <div className='employee-menu-list'>
                <a href='/employee/dashboard' className='item active'><FaHome />Dashboard</a>
                <a href='/employee/submit_ticket' className='item'><LuTickets />Submit Ticket</a>
...
export default EmployeeDashboard_Sidebar
